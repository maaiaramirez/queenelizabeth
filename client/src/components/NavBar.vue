...
<template>
  <header class="public-topbar">
    ...
    <ul class="public-topbar__links" v-if="!auth.isLoggedIn">
      <li><RouterLink :to="{ name: 'home', hash: '#metodologia' }">Metodología</RouterLink></li>
      <li><RouterLink :to="{ name: 'home', hash: '#tutores' }">Tutores</RouterLink></li>
      <li><RouterLink :to="{ name: 'home', hash: '#niveles' }">Niveles</RouterLink></li>
      <li><RouterLink :to="{ name: 'home', hash: '#testimonios' }">Testimonios</RouterLink></li>
    </ul>
